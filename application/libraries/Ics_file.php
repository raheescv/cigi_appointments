...
class Ics_file {
    ...
    public function get_stream($appointment, $service, $provider, $customer)
    {
        ...
        $description = [
            ...
            lang('qualification') . ': ' . $provider['address'],
            lang('city_or_state') . ': ' . $provider['city'],
            lang('state') . ': ' . $provider['zip_code'],
            '',
            lang('customer'),
            '',
            ...
            lang('qualification') . ': ' . $customer['address'],
            lang('city_or_state') . ': ' . $customer['city'],
            lang('state') . ': ' . $customer['zip_code'],
            '',
            lang('query_or_notes'),
            '',
            $appointment['notes'],
